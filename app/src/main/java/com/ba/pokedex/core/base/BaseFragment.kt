...
import com.ba.pokedex.core.utils.livedata.Event
...
abstract class BaseFragment<DB : ViewDataBinding> : Fragment(), IBaseView, KoinComponent {
    ...
    private val loadingView by lazy { com.ba.pokedex.core.utils.views.LoadingView(getViewContext()) }
    ...
    open fun initComposable(view: ComposeView, content: @Composable () -> Unit) {
        view.apply {
